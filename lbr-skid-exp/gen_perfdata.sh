...
perf record -e r20cc:u -j any_ret,u -c 8 -- ./gcc_base.stc 166.i -o 166.s
mv perf.data ${tmpdir}/perf.data.gcc.166.ret.c8

perf record -e r20cc:u -j any_ret,ind_call,u -c 8 -- ./gcc_base.stc 166.i -o 166.s
mv perf.data ${tmpdir}/perf.data.gcc.166.ret_indjmp_indcall.c8
...
#perf record -e r20cc:u -j any_ret,u -c 8 -- ls ..
#mv perf.data ${tmpdir}/perf.data.ls.any_ret.c8
